...
\begin{document}
    \education
        \cvblock{}
				...
				\cvsubbullet{Contributions: Provided new state-of-the-art error bounds for controlling iterates of stochastic iterative schemes: mini-batch Heavyball Momentum and mini-batch SGD.}
		...
		\cvblock{}
                ...
                {Transition Year}
                {Additional MSc Requirements at D-MATH}
                {}
                {
...
%                  	
    ...
    \experience
        ...
        \cvblock{Oct 2023 -- Mar 2024}
                ...
                {
                    \vspace{1.5mm}\cvbullet{Developed a novel method called Dropsembles for uncertainty estimation in tuned implicit functions, in collaboration with my supervisor}
...
%                }
    ...
    \skills
        ...
        \skillgroup{Numerical Libraries}{Eigen, LehrFEM++ (implementing and solving PDEs);} 
...
%        \skillgroup{Soft Skills}{ Adept at creating visually intuitive and elegant solutions to complex problems, with a particular talent for developing clear, concise mathematical proofs and explanatory models;} 
        \skillgroup{Languages}{French (native), Italian (native), German (Native), English (Advanced).}
